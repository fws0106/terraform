...
output "core_account_name"   { value = "commom_account" }
output "core_root_account_name"   { value = "hwstaff_intl_apac_kar_commom" }
output "core_account_ak"   { value = "9COZOQKZII1EZ04PDN1S" }
output "core_account_sk"   { value = "BKYhgTqRd7e4rfaQQzyVUR5QtEEezA27zMdehjgP" }   